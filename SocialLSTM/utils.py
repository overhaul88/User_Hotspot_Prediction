...
class DataLoader():
    ...
    def __init__(self,f_prefix, batch_size=5, seq_length=20, num_of_validation = 0, forcePreProcess=False, infer=False, generate = False):
        ...
        self.train_dataset = self.get_dataset_path('D:/AKG/GSN/social-lstm/data/train/')
        self.test_dataset = self.get_dataset_path('D:/AKG/GSN/social-lstm/data/test/')
        self.validation_dataset = self.get_dataset_path('D:/AKG/GSN/social-lstm/data/valid/')
        # self.train_dataset = ['D:/AKG/GSN/social-lstm/data/train/biwi']
    ...
    def get_dataset_path(self, base_path):
        dataset = []
